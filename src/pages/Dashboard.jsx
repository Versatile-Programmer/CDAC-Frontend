    ...
    <MainLayout>
      <div className="space-y-8 p-4 md:p-6">
        ...
        <section>
          ...
          {/* *** FIX: Added a non-blocking error message for notification failures *** */}
          {notificationsError && (
            <div className="p-3 mb-4 text-sm text-red-700 bg-red-100 rounded-lg" role="alert">
              <span className="font-medium">Error:</span> Could not load activity counts. The dashboard will remain functional.
            </div>
          )}
